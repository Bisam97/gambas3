...
static const char *const _public_dir = ".public";
static const char *_allowed_hidden_files[] = { ".gambas", ".info", ".list", ".test", ".lang", ".action", ".connection", ".component", _public_dir, NULL };
			...
			for(;;)
			{
				...
				for (i = 0; i < nfile; i++)
				{
					...
					if (*file_name == '.')
					{
						...
						if (*p == _public_dir && _ignore_public)
							continue;
					}
