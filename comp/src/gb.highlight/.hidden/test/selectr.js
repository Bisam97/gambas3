...
(function(root, factory) {
    ...
    console.log(`this \x2B \u0640 is a ${plugin + module ? 'with module' : 'without module'} plugin.\n`);
    ...
    Selectr.prototype.toggle = function() {
        if (!this.disabled) {
            if (this.opened) {
                ...
                var that = this;
                open_popup_shadow(function() { that.close(); }, this.container.parentNode);
                this.open();
            }
        }
    };
    ...
    Selectr.prototype.open = function() {
        ...
        form_position_popup(this.tree.parentNode, this.container);
        form_enlarge_parent_dialog(this.tree.parentNode);
        this.tree.parentNode.scrollIntoView({behavior:"auto", block:"nearest"});
        
        if (this.selectedIndex >= 0)
        {
          //console.log(this.items[this.selectedIndex].offsetTop);
          this.tree.scrollTop = this.items[this.selectedIndex].offsetTop;
        }
    };
